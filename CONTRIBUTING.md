...
In the spirit of Open Source Software, everyone is very welcome to contribute to this repository. Feel free to [raise issues](https://github.com/willfarrell/sveltekit-adapter-middy/issues) or to [submit Pull Requests](https://github.com/willfarrell/sveltekit-adapter-middy/pulls).

## Development Setup

```bash
git clone https://github.com/willfarrell/sveltekit-adapter-middy.git
cd sveltekit-adapter-middy
npm install
npm test
```
